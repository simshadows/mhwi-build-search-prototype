...
"""
Filename: search_legacyimplementation.py
Author:   contact@simshadows.com

This file contains the old (slower) search implementation.

I intend to get rid of this once I feel like I no longer have any use for the components in here.
"""
...
def find_highest_efr_build_legacyimpl(search_parameters_jsonstr):
